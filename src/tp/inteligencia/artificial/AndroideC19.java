...
public class AndroideC19 extends SearchBasedAgent {
    ...
    public AndroideC19(ArrayList<ArrayList<Integer>> positions, HashMap<Integer, Collection<AC19NodoAlcanzable>> map,ArrayList<Integer> posicionesEnfermos, HashMap<Integer,Integer> cuadrasCortadas) {
        // Robot agent goal
        ...
        // Robot agent state
        AndroideC19State agentState = new AndroideC19State(positions, map,posicionesEnfermos,cuadrasCortadas);

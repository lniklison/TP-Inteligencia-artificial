 ...
 * {@link ar.edu.utn.frsf.isi.died2015.metro.vistas.dialogos.DialogoInspeccion DialogoInspeccion}.
 *
 * @see {@link ar.edu.utn.frsf.isi.died2015.metro.vistas.dialogos.DialogoInspeccion
 *      DialogoInspeccion}
 * @author Guimar Nicolás Javier, Madoery Federico y Raimondi Gino.
 * @version 1.0
 */
public interface InspeccionListener extends EventListener
{
    /**
     * Método invocado cuando el usuario presiona el botón "Confirmar inspección" del diálogo.
     * 
     * @param e

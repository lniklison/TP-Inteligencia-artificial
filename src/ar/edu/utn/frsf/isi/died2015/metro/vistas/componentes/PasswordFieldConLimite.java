...
/**
 * Clase que crea un JPasswordField con la restricción de la cantidad de caracteres que se pueden
 ...
 */
public class PasswordFieldConLimite extends JPasswordField
{
    private static final long serialVersionUID = 217419526315057711L;
     ...
     */
    public PasswordFieldConLimite(int limiteCaracteres, Boolean mayusculas)
    {
        super();
        doc = new PlainDocument();
     ...
     * @param mayusculas
     *            true para forzar el uso de mayúsculas.
     * @see {@link javax.swing.JPasswordField(int columns)}
     */
    public PasswordFieldConLimite(int columnas, int limiteCaracteres, Boolean mayusculas)
    {
        super(columnas);
        doc = new PlainDocument();

...
public class ModeloTablaInspeccion extends AbstractTableModel
{
    ...
    public ModeloTablaInspeccion()
    {
        super();
        this.datos = new Vector<Reclamo>();
    }

    public ModeloTablaInspeccion(Vector<Reclamo> datos, String[] nombresColumnas)
    {
        super();
        this.datos = datos;
